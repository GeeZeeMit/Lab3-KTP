...
public class AStarApp
{
    ...
    private void initGUI()
    {
        ...
        mapCells[startLoc.xCoordinate][startLoc.yCoordinate].setEndpoint(true);
        mapCells[finishLoc.xCoordinate][finishLoc.yCoordinate].setEndpoint(true);
    }
    ...
    private void findAndShowPath()
    {
        ...
        while (wp != null)
        {
            ...
            mapCells[loc.xCoordinate][loc.yCoordinate].setPath(true);
