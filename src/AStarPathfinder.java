...
public class AStarPathfinder
{
    ...
    private static void takeNextStep(Waypoint currWP, AStarState state)
    {
        ...
        for (int y = loc.yCoordinate - 1; y <= loc.yCoordinate + 1; y++)
        {
            for (int x = loc.xCoordinate - 1; x <= loc.xCoordinate + 1; x++)
            {
    ...
    {
        int dx = destLoc.xCoordinate - currLoc.xCoordinate;
        int dy = destLoc.yCoordinate - currLoc.yCoordinate;
